...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 74</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=74">Community</a></div>
                        <div><a href="/en/eg/eghome?id=74">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=74">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=74">Proposal</a>
...
<div class="header1">JSR 74: Public Key Cryptography Standards (PKCS) 1.0</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>JSR Review Ballot </td>
                                            ...
                                            <td><a href="results?id=66">View results</a></td>
...
<span style="padding: 10px; display: block;">
    ...
    <b> Reason:</b> Withdrawn as the main goals of this JSR have been achieved and delivered through J2SE and other JCP specifications.<br>
...
<p>
		...
		<b> Reason:</b> Withdrawn as the main goals of this JSR have been achieved and delivered through J2SE and other JCP specifications.<br> <br>


<a name="updates"><font size="+2">Updates to the JSR</font></a><P>
Due to the change in Specification Lead, the following changes have been made to the <a href="#orig">original
specification</a>:

<BR>
<P><b>Specification Lead:</b> Anthony Nadalin and Seema Malkani</P>

<P><b>E-Mail Address:</b> Anthony Nadalin - <A href="mailto:drsecure&#64;us.ibm.com">drsecure&#64;us.ibm.com</a><BR>Seema Malkani - <A href="mailto:seema.malkani&#64;eng.sun.com">seema.malkani&#64;eng.sun.com</a></P>

<P><b>Telephone Number:</b> Anthony Nadalin - +1 512 838 3823<BR>Seema Malkani - +1 650 786 3454</P>

<P><b>Fax Number:</b> Anthony Nadalin - +1 512 838 3823<BR>Seema Malkani - +1 650 786 5896</P>

<H4>2.6 Is there a proposed package name for the API Specification? (i.e., <TT>javapi.something</TT>, <TT>org.
something</TT>, etc.)</H4>

<P>javax.security.pkcs.pkcs1<BR>
javax.security.pkcs.pkcs5 <BR>
javax.security.pkcs.pkcs7 <BR>
javax.security.pkcs.pkcs8 <BR>
javax.security.pkcs.pkcs9 <BR>
javax.security.pkcs.pkcs10 <BR>
javax.security.pkcs.pkcs12</P>
...
<P><b>Submitting Member:</b> Anthony Nadalin</P>

<P><b>Name of Contact Person:</b> Anthony Nadalin or Maxine Erlund</P>

<P><b>E-Mail Address:</b> Anthony Nadalin - <a href="mailto:drsecure&#64;us.ibm.com">drsecure&#64;us.ibm.com</a><BR>Maxine Erlund - <A href="mailto:maxine.erlund&#64;eng.sun.com">maxine.erlund&#64;eng.sun.com</a> </P>

<P><b>Telephone Number:</b> Anthony Nadalin - (512)838-3823<BR>Maxine Erlund - (408)517-5486</P>

<P><b>Fax Number:</b> Anthony Nadalin - (512)838-3823<BR>Maxine Erlund - (408)863-3155</P>

<BR>
<P><b>Specification Lead:</b> Anthony Nadalin and Ram Marti</P>

<P><b>E-Mail Address:</b> Anthony Nadalin - <A href="mailto:drsecure&#64;us.ibm.com">drsecure&#64;us.ibm.com</a><BR>Ram Marti - <A href="mailto:Ram.Marti&#64;eng.sun.com">Ram.Marti&#64;eng.sun.com</a></P>

<P><b>Telephone Number:</b> Anthony Nadalin - (512)838-3823<BR>Ram Marti - (408)517-5486</P>

<P><b>Fax Number:</b> Anthony Nadalin - (512)838-3823<BR>Ram Marti - (408)863-3155</P>
<P>
(<font color="red">NOTE</font> that <a href="#update">this information has been updated</a> since the original
 submission.
<BR>
...
<P>IBM _ Anthony Nadalin<p>

Sun - Ram Marti<p>

Critical Path - Hemma Prafullchandra</P>
...
<P>This JSR is to define a standard set of APIs for a subset of the Public Key Cryptography Standards (PKCS#1,
 #5, #7, #8, #9, #10 & #12) and to provide a reference implementation of these.</P>

<H4>2.2 What is the target Java platform? (i.e., desktop, server, personal, embedded, card, etc.)</H4>

<P>JDK 2 SDK, Standard Edition, V 1.4 and above</P>

<H4>2.3 What need of the Java community will be addressed by the proposed specification?</H4>

<P>The PKCS family of standards addresses the following need: an agreed-upon standard format for transferred data based
...
certification request syntax, and personal information exchange syntax.</P>

<H4>2.4 Why isn't this need met by existing specifications?</H4>

<P>JDK 2 SDK, Standard Edition does not provide a standard set of APIs for a subset of the Public Key Cryptography
Standards (PKCS#1, #5, #7, #8, #9, #10 & #12).</P>

<H4>2.5 Please give a short description of the underlying technology or technologies:</H4>

<P>The Public Key Cryptography Standards is a set of de-facto standards that is in wide use in the industry to
day. They
...
The editors of the PKCSs have traditionally been RSA Data Security Inc. However, for pkcs#7 the change control
 has
been handed over to the IETF and the revisions are seen in RFC2630. <P>

Encryption (PKCS #1) describes a method for encrypting data using the RSA public-key cryptosystem. Its intended use
is in the construction of digital signatures and digital envelopes, as described in PKCS #7.<P>
...
arbitrary octet strings, its intended primary application to public-key cryptography is for encrypting private
 keys
when transferring them from one computer system to another. <P>
...
means for disseminating certificates and certificate-revocation lists. <P>
...
syntax for encrypted private keys. A password-based encryption algorithm (e.g., one of those described in PKCS
 #5)
could be used to encrypt the private-key information. <P>
...
the scope of PKCS #10. A PKCS #7 message is one possibility.) <P>
...
personal identity information</P>

<H4>2.6 Is there a proposed package name for the API Specification? (i.e., <TT>javapi.something</TT>, <TT>org.
something</TT>, etc.)</H4>

<P>java.security.pkcs1<BR>
java.security.pkcs5 <BR>
java.security.pkcs7 <BR>
java.security.pkcs8 <BR>
java.security.pkcs9 <BR>
java.security.pkcs10 <BR>
java.security.pkcs12</P>
<BR><font color="red">Note</font> that this information <a href="#update">has been updated</a> from the original request.<P>
...
<P>Documents describing PKCS can be found at <A href="http://www.rsa.com/rsalabs/pubs/pkcs">http://www.rsa.com/rsalabs/pubs/pkcs</a> </P>

<H4>3.2 Explanation of how these items might be used as a starting point for the work.</H4>

<P>These documents describe the PKCS technology standards.</P>
</p>
