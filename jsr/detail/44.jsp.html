...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 44</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=44">Community</a></div>
                        <div><a href="/en/eg/eghome?id=44">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=44">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=44">Proposal</a>
...
<div class="header1">JSR 44: Braille API Specification</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
...
<span style="padding: 10px; display: block;">
    ...
    <b> Reason:</b> Withdrawn at the request of the submitter. Community support was not sufficient to support an Expert Group.<br>
    ...
    <br><br>
        <b>Description</b>:<br>
        This API for Braille lines would have eased use of these devices and allowed faster introduction of new Braille lines in the Java<sup><font size="-2">TM</font></sup> market by writing a driver for Braille.
    <br><br>
...
<p>
		...
		<b> Reason:</b> Withdrawn at the request of the submitter. Community support was not sufficient to support an Expert Group.<br> <br>
...
<B>Original Summary</b>: Braille API Specification provides an API to work with Braille lines making the use of these devices easier and allowing a faster introduction of new Braille lines in the Java<SUP><FONT SIZE="-2">TM</font></sup> market by just writing a driver for Braille.
...
<td BGCOLOR="#CCCCFF">ONCE (Organizaci?n Nacional de Ciegos de Espa?a)</td>
</tr>

<tr>
<td ALIGN=RIGHT BGCOLOR="#9999FF">Name of Contact Person:</td>

<td BGCOLOR="#9999FF">Ram?n Cabello</td>
</tr>

<tr>
<td ALIGN=RIGHT BGCOLOR="#CCCCFF">E-Mail Address:</td>

<td BGCOLOR="#CCCCFF"><a href="mailto:rcl&#64;once.es">rcl&#64;once.es</a></td>
</tr>

<tr>
<td ALIGN=RIGHT BGCOLOR="#9999FF">Telephone Number:</td>

<td BGCOLOR="#9999FF">+34 91 589 06 30</td>
</tr>

<tr>
<td ALIGN=RIGHT BGCOLOR="#CCCCFF">Fax Number:</td>

<td BGCOLOR="#CCCCFF">+34 91 589 90 49</td>
</tr>
</table>
...
<tr>
<td>This is a proposal to develop a set of
...
<p>The capabilities of the Braille Line devices could then be
...
<tr>
<td>The inital target platform is J2SE but the APIs could be
of use to any client device in the desktop and hand-held device space
that interfaces with Braille Line devices.</td>
</tr>
...
<tr>
<td>There are currently no APIs that allow for braille input/output
devices (like the Braille Line device) to be utilized by Java platform
applications in a standard way.</td>
</tr>
...
<tr>
<td>There is no current API specification that meets this need in
the Java platform space. The only industry API for the Braille
Line device has been developed specifically for the Microsoft Windows<SUP><FONT SIZE="-2">TM</FONT></SUP>
environment.</td>
</tr>
...
<tr>
<td>The Braille Line device allows blind users to read output from
...
keyboard combination provide I/O capability for a sighted person.</td>
</tr>
...
<tr>
<td><tt>javax.braille</tt> or perhaps <tt>org.once.braille</tt></td>
</tr>
...
<tr>
<td>The API set will provide acces to Braille Line devices that will
...
the application and the device user.</td>
</tr>
...
<tr>
<td>Both the Japanese Braille Code and Level-2 Braille Code will need
to be accomodated.</td>
</tr>
...
<tr>
<td>Please see the attached document with a proposed starting point
for this work: <a href="/content/main/jsr/detail/materials/JBrailleSpecs.pdf">JBrailleSpecs.pdf</a></td>
</tr>
...
<tr>
<td>The specification included with this submission can be used
as a starting point because it provides the basic functionality
required by any Braille Line device. The plan is to enhance those capabilies.</td>
</tr>
</table>
</p>
