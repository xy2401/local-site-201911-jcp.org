...
<p>
	...
	<div class="header3">JSR Review</div>

	<p>The Java Specification Request (JSR) is the first step in developing or revising a Java technology specification
	(see <a href="/en/procedures/jcp2#1">Section 1</a> of the Java Community Process document).</p>

	<p><a href="../participation/members">Members</a> of the Java Community Process may submit a JSR using the
	<a href="/en/jsr/proposal">Specification Proposal form.</a></p>

	<div class="header3">New JSRs</div>

	<p>The following list contains new JSRs that have been recently submitted to the JCP. You
	are encouraged to read them and send your comments to the alias listed on the JSR. If no alias is
	listed on the JSR, please send your comments to jsr-comments<fake_tag>&#064;</fake_tag>jcp.org.</p>

	<p>Your comments are important. They help to decide whether a JSR is accepted or rejected.</p>
