...
<p>
	...
	<div class="header3">Proposed Final Draft Specifications</div>

	<p>After completion of Public Review, a Proposed Final Draft of the Specification
	is published, as described in <a href="/en/procedures/jcp2#3.2">Section 3.2</a>.
	...
	of the RI and/or the TCK.</p>

	<p>Note: In JCP 1.0, this draft was called the First Public Release, and the TCK
	was called the Compatibility Test Suite (CTS).</p>

	<div class="header3">Download Proposed Final Drafts</div>

	<p>The following Proposed Final Draft specifications are available for download.
	...
	subject to the terms of the license.</p>
