...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 2</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=2">Community</a></div>
                        <div><a href="/en/eg/eghome?id=2">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=2">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=2">Proposal</a>
...
<div class="header1">JSR 2: Boundary-Scan API</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
...
<span style="padding: 10px; display: block;">
    ...
    <br><br>
        <b>Description</b>:<br>
        This API targeted the JavaCard<sup><font size="-2">TM</font></sup> platform so as to allow it to be usable on all available Java<sup><font size="-2">TM</font></sup> virtual machines from the very smallest to the most sophisticated.
    <br><br>
...
<A HREF="#1"> Identification</A>   |  
          ...
          <a href="#4">Additional Contributions</a></font><p>
         <BR>
<B>Original Summary</b>: This API was targeted to the JavaCard<SUP><FONT SIZE="-2">TM</font></sup> platform so as to allow it to be usable on all available Java<SUP><FONT SIZE="-2">TM</font></sup> virtual machines from the very smallest to the most sophisticated.
<p>
...
E-mail: <A HREF="mailto:neil.jacobson&#64;xilinx.com?subject=JSR-Boundary-Scan API">neil.jacobson&#64;xilinx.com</A>
Phone: 408 879 4885
Fax: 408 879 5171
</PRE>
...
This API is targeted to the JavaCard<FONT SIZE=-2><SUP>TM</SUP></FONT> platform so as to allow it to be useable on all available Java VM's from the very smallest to the most sophisticated.  It is important to note that only the JavaCard VM is require and not the associated API.  It is not expected that the Java API for Boundary-Scan would ever run on a smart card.  It is true, however, that it could be hosted on an 8 bit or simpler microprocessor just like those used on smart cards.
...
<LI>IEEE Std 1149.1 (includes IEEE Std 1149.1a-1193) IEEE Standard Test Access Port and Boundary-Scan Architecture, ISBN 1-55937-350-4

<LI>The Boundary-Scan Handbook, Kenneth Parker, Kluwer Academic Publishers, 1993

<LI>Boundary-Scan Test: A Practical Approach, Harry Bleeker, Peter van den Eijnden and  Frans de Jong, Kluwer Academic Publishers, 1993
...
Here is an example <A HREF="/aboutJava/communityprocess/contrib/xilinx/index.html">boundary-scan application</A>
created by Xilinx that you can download and use.
</p>
