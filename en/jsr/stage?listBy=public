...
<p>
	...
	<div class="header3">Public Review of Draft Specifications</div>

	<p>After completion of Early Draft Review (see <a href="/en/procedures/jcp2#2.3">Section 2.3</a>),
	a draft specification is made available for Public Review, as described in
	<a href="/en/procedures/jcp2#3">Section 3.1</a>.</p>

	<div class="header3">Download Public Drafts</div>

	<p>The following draft specifications are available for Public Review. The
	download pages will tell when each review period closes and where you can send comments.
	The Expert Group writing each draft is required to read and consider all comments submitted.</p>
	...
	<div class="header3">Recently Closed Public Reviews</div>
