...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 95</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=95">Community</a></div>
                        <div><a href="/en/eg/eghome?id=95">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=95">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=95">Proposal</a>
...
<div class="header1">JSR 95: J2EE<sup><font size="-2">TM</font></sup> Activity Service for Extended Transactions</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>Final Approval Ballot </td>
                                            ...
                                            <td><a href="results?id=3687">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Proposed Final Draft </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/first/jsr095/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Public Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/review/jsr095/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Draft Ballot </td>
                                            ...
                                            <td><a href="results?id=1575">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Review </td>
                                            ...
                                            <td><a href="http://www2.jcp.org/aboutJava/communityprocess/participant/jsr095/index.html">Login page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>JSR Review Ballot </td>
                                            ...
                                            <td><a href="results?id=6">View results</a></td>
...
<P><b>Name of Contact Person:</b> Tony Storey</P>

<P><b>E-Mail Address:</b> tony_storey&#64;uk.ibm.com</P>

<P><b>Telephone Number:</b> +44 1962 815358</P>

<P><b>Fax Number:</b> +44 1962 817961</P>

<BR>
<P><b>Specification Lead:</b> Ian Robinson</P>

<P><b>E-Mail Address:</b> ian_robinson&#64;uk.ibm.com</P>

<P><b>Telephone Number:</b>  +44 1962 818626</P>
...
<P>IBM has a list of candidate expert member companies some of which have already expressed a wish to participate.</P>
...
<P>A framework that supports a large variety of Extended Transaction models.
...
<P>An increasingly large number of distributed applications are constructed by composing existing applications. 
...
architecture for Workflow Engines, Component Management Middleware, an EJB<sup><font size=-2>TM</font></sup> Container
...
<A HREF="http://cgi.omg.org/cgi-bin/doc?orbos/2000-06-19">the OMG document server </A></P>
</P>

<H4>2.4 Why isn't this need met by existing specifications?</H4>

<P>The JTA and JTS specifications are suitable for individual transactions with ACID properties. 
However, as stated above, higher level 
functionality is required for supporting flexible ways of composing an application using transactions, 
with the support for enabling the application to
possess some or all ACID properties. Such support should include facilities for supporting business rules, 
programming rules, and data usage patterns.
Long-running applications and activities can be structured as many independent, short-duration top-level 
transactions, to form a logical long-running  transaction.</P>

<H4>2.5 Please give a short description of the underlying technology or technologies:</H4>

<P>The J2EE<SUP><FONT SIZE="-2">TM</FONT></SUP> Activity Service for Extended Transactions 
is based upon the technologies that are defined and standardized as part of 
the Java 2? platform, Enterprise Edition.
Specifically, the Activity Service leverages concepts and
...
<P>The Activity Service is based on the security architecture defined as part of Java
2? platform,  Standard Edition and Java 2?
platform, Enterprise Edition.</P>

<H4>2.9 Are there any internationalization or localization issues?</H4>

<P>No localization issues; where internationalization is concerned, the Activity Service use the I18N support in the Java 2?
...
<P>Currently planned to be available 3Q2001</P>
...
<li>The OMG's Activity Service specification 
<A HREF="http://cgi.omg.org/cgi-bin/doc?orbos/2000-06-19"> http://cgi.omg.org/cgi-bin/doc?orbos/2000-06-19 </A> 
on the OMG document server.</li>

<li>Since an EJB<sup><font size=-2>TM</font></sup> Container may wish to deploy the Activity Service, 
the Enterprise JavaBeans<SUP><FONT SIZE="-2">TM</FONT></SUP> 
<a href="http://java.sun.com/products/ejb/index.html">specification </a>is especially relevant </li>
...
<li>
JDBC<sup><font size=-2>TM</font></sup> 2.0 standard extension API - 
<a href="http://java.sun.com/products/jdbc/jdbcse2.html">http://java.sun.com/products/jdbc/jdbcse2.html</a></li>
...
<P>The OMG's Activity Service specification <A HREF="http://cgi.omg.org/cgi-bin/doc?orbos/2000-06-19"> http://cgi.omg.org/cgi-bin/doc?orbos/2000-06-19 </A>
should be read first. IBM will shortly (planned for December 2000) have a specification of all the Java packages and
interfaces for consideration.</P>
