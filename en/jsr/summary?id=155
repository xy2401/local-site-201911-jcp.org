...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 155</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=155">Community</a></div>
                        <div><a href="/en/eg/eghome?id=155">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=155">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=155">Proposal</a>
...
<div class="header1">JSR 155: Web Services Security Assertions</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>JSR Review Ballot </td>
                                            ...
                                            <td><a href="results?id=827">View results</a></td>
...
<span style="padding: 10px; display: block;">
    ...
    <b> Reason:</b> Withdrawn by the JSR 155 Spec Lead due to changing industry focus and continued JSR inactivity.<br>
   ...
   <!-- ****************************************** -->
			...
			<tr valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr><td><ul><li>I would like to <a href="egnom?id=155">join this JSR</a></li></ul></td></tr>
...
<p>
		...
		<b> Reason:</b> Withdrawn by the JSR 155 Spec Lead due to changing industry focus and continued JSR inactivity.<br> <br>
...
<P><b>Submitting Member:</b> Cisco Systems</P>

<P><b>Name of Contact Person:</b> Krishna Sankar</P>

<P><b>E-Mail Address:</b> ksankar&#64;cisco.com</P>

<P><b>Telephone Number:</b> +1 408 853 8475</P>

<P><b>Fax Number:</b>  </P>

<BR>
<P><b>Specification Lead:</b> Krishna Sankar</P>
...
<P>One of the important pieces in the web services space is the exchange of assertions securely between web services. The OASIS SAML is
...
the other JSRs on messaging, SOAP & security.<P>
...
based on the JAXM and Java-RPC JSRs.</P>
...
<P>Exchanging assertions in the web services space.</P>

<H4>2.4 Why isn't this need met by existing specifications?</H4>

<P>None of them address the assertions and patterns.</P>

<H4>2.5 Please give a short description of the underlying technology or technologies:</H4>

<P>XML, XML Signature, XML ENcryption, SOAP, messaging.<P>
...
<P>OASIS SAML specifications, SOAP specification, W3C XML Signature and XML Encryption<P>
OASIS SAML Web Site : <a href="http://www.oasis-open.org/committees/security/"> http://www.oasis-open.org/committees/security/</a><BR>
SOAP Specification : <a href="http://www.w3.org/TR/SOAP/"> http://www.w3.org/TR/SOAP/</a><BR>
W3C XML Signature : <a href="http://www.w3.org/TR/xmldsig-core/"> http://www.w3.org/TR/xmldsig-core/</a><BR>
W3C XML Encryption : <a href="http://www.w3.org/TR/xmlenc-core/"> http://www.w3.org/TR/xmlenc-core/</a><BR>
W3C XML Protocol Activity : <a href="http://www.w3.org/2000/xp/"> http://www.w3.org/2000/xp/</a>
</P>

<H4>3.2 Explanation of how these items might be used as a starting point for the work.</H4>

<P>The SAML specifications define the assertions. The security (signature and encryption come from the W3C specifications)</P>
...
<P>This JSR would leverage on the JAXM,JAX-RPC and the three Java security JSRs.</P>
