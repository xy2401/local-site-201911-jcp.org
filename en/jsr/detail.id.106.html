...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 106</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=106">Community</a></div>
                        <div><a href="/en/eg/eghome?id=106">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=106">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=106">Proposal</a>
...
<div class="header1">JSR 106: XML Digital Encryption APIs</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>Public Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/pr/jsr106/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Draft Ballot </td>
                                            ...
                                            <td><a href="results?id=3097">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Review </td>
                                            ...
                                            <td><a href="http://www2.jcp.org/aboutJava/communityprocess/participant/jsr106/index.html">Login page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>JSR Review Ballot </td>
                                            ...
                                            <td><a href="results?id=98">View results</a></td>
...
define and incorporate the high level implementation independent Java APIs.
   ...
   <!-- ****************************************** -->
			...
			<tr valign="top">
                            ...
                            <td>IAIK Graz University of Technology</td>
...
<p><b>Specification Lead:</b> Anthony Nadalin</p>

<p><b>E-Mail Address:</b> Anthony Nadalin - <a
href="mailto:drsecure&#64;us.ibm.com">drsecure&#64;us.ibm.com</a></p>

<p><b>Telephone Number:</b> Anthony Nadalin - +1 512 436 9568</p>
...
style="mso-spacerun: yes">  </span>for XML digital encryption services. XML
Encryption can be used to perform fine-grained, element-based encryption of
fragments within an XML Document as well as encrypt arbitrary binary data and
include this within an XML document. </P>
...
<P>Today there is no standard set
of APIs for XML digital encryption services. This
JSR provides a Java API to the XML Digital encryption services.</P>

<H4>2.4 Why isn't this need met by existing specifications?</H4>

<P>There is no existing
specification in JDK 2 SDK for accessing XML Digital Encryption via a
standard set of APIs.</P>

<H4>2.5 Please give a short description of the underlying technology or technologies:</H4>

<P>This JSR is to define a standard set of APIs for XML digital encryption services. XML
Encryption can be used to perform fine-grained, element-based encryption of
fragments within an XML Document as well as encrypt arbitrary binary data and
include this within an XML document. The representation of the encrypted data
and keying material must be both efficient and flexible while using existing
functionality within J2SE. XML encryption must provide consistency and
compatibility with exiting XML Digital Signature specification as defined by
the W3C.</P>

<H4>2.6 Is there a proposed package name for the API Specification? (i.e., <TT>javapi.something</TT>, <TT>org.something</TT>, etc.)</H4>

<P>javax.security.xml.enc</P>
...
<P>I'd like to propose a
9-12 week schedule, with 2-3 internal review cycles within that timeframe:<P>

6/1 Release API docs
and preliminary spec.<BR>
...
Java Cryptography Extension <a href="http://java.sun.com/products/jce">http://java.sun.com/products/jce</a></p>
<P>
PKCS Specifications <a href="http://www.rsasecurity.com/rsalabs/pkcs/index.html">http://www.rsasecurity.com/rsalabs/pkcs/index.html</a></P>
...
this describes the basic element format and also the Java Cryptography
Extension that can be used to form the bases of a set of Java APIs.</P>
</p>
