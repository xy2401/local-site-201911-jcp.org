...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 184</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=184">Community</a></div>
                        <div><a href="/en/eg/eghome?id=184">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=184">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=184">Proposal</a>
...
<div class="header1">JSR 184: Mobile 3D Graphics API for J2ME<sup><font size="-2">TM</font></sup></div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>Maintenance Draft Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/maintenance/jsr184/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Final Approval Ballot </td>
                                            ...
                                            <td><a href="results?id=2237">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Proposed Final Draft </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/first/jsr184/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Public Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/review/jsr184/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Draft Ballot </td>
                                            ...
                                            <td><a href="results?id=1730">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Review </td>
                                            ...
                                            <td><a href="http://www2.jcp.org/aboutJava/communityprocess/participant/jsr184/index.html">Login page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>JSR Review Ballot </td>
                                            ...
                                            <td><a href="results?id=1161">View results</a></td>
...
<span style="padding: 10px; display: block;">
   ...
   <!-- ****************************************** -->
			...
			<tr valign="top">
                            ...
                            <td>HI Corporation</td>
			</tr>


			<tr valign="top">
                            <td width="20" nowrap>&nbsp;</td> <!-- Gutter //-->
                            <td>Hybrid Graphics Ltd.</td>
...
<B><U>2012.08.29</u></b>: North Sixty-One has become the Co-Maintenance Lead.

<P><b>Maintenance Lead:</b> Erkki Rysä</P>

<P><b>E-Mail Address:</b> jsr184<faketag></faketag>&#64;northsixtyone.com</P>
...
<P><b>Submitting Member:</b> Nokia Corporation</P>

<P><b>Name of Contact Person:</b> Kari Pulli</P>

<P><b>E-Mail Address:</b> kari.pulli&#64;nokia.com</P>

<P><b>Telephone Number:</b> +358 7180 48975</P>

<P><b>Fax Number:</b> +358 7180 52244</P>

<BR>
<P><b>Specification Lead:</b> Jyri Huopaniemi</P>

<P><b>E-Mail Address:</b> jyri.huopaniemi&#64;nokia.com</P>

<P><b>Telephone Number:</b> +358 7180 37309</P>

<P><b>Fax Number:</b> +358 7180 37133</P>
...
<P>This proposal specifies a lightweight, interactive 3D graphics API, which sits alongside J2ME and MIDP as an optional package. 
<P>
...
3D graphics hardware. The API may therefore support features that are not strictly necessary on the very low-end platforms. </P>

<H4>2.2 What is the target Java platform? (i.e., desktop, server, personal, embedded, card, etc.)</H4>

<P>The target platform of this API is J2ME/CLDC. The API is proposed to be an optional package to be used together with several J2ME
...
subset should be of the order of 100K of ROM/Flash space for a well-optimised implementation. </P>

<H4>2.3 What need of the Java community will be addressed by the proposed specification?</H4>

<P>The specification brings support for 3D graphics to J2ME. Synthetically coded content, such as 3D graphics, has properties that
...
capabilities in a manner which makes content development natural and easy for MIDP developers. </P>

<H4>2.4 Why isn't this need met by existing specifications?</H4>

<P>Current proposals for integration of 3D into a Java environment are unsuitable for constrained devices due to ROM footprint, RAM
...
<UL>
      <LI>JSR-134 - Gaming API is designed and optimised for gaming, targeting the CDC platform. While 3D is useful for games, it is
      ...
      <LI>JSR-135 - Mobile Media API is a high-level control API for different media types, and it does not address interactive 3D
...
<UL>
      <LI>JSR-148 - 3D Media Utilities addresses volumetric imaging and 3D vector math. The volumetric imaging part of the JSR are
      ...
      <LI>JSR-912 - Java 3D is very large by J2ME standards. It is unclear whether even a ?cut down? version of JSR-912 would
      perform efficiently on the smallest platforms, given the design assumptions made for Java 3D. </ul></P>

<H4>2.5 Please give a short description of the underlying technology or technologies:</H4>

<P>Mobile devices may feature a great variety of graphical capabilities. Some of the target devices may only have a black & white
...
<UL>
      <LI>Enable the use of 3D graphics on a variety of different applications 
      <LI>Do not assume the existence of relatively high-end hardware capabilities 
      <LI>Do not impose arbitrary limits on the size or complexity of 3D content 
      <LI>Support sophisticated features also on low-end platforms 
      <LI>Maintain low ROM and RAM footprint 
</UL><P>
...
<P>No, although the proposed implementation will be dependent on the specific profile implementations, such as MIDP, to transfer
pixel arrays to the screen. </P>

<H4>2.8 Are there any security issues that cannot be addressed by the current security model?</H4>

<P>None known or anticipated.</P>
...
<P>The specification is expected to be finalized during Q4/2002.</P>

<H4>2.12 Please describe the anticipated working model for the Expert Group working on developing this 
specification.</H4>

<P>It is up to the expert group to work out the details, but we are proposing to have 2-3 face-to-face meetings in the process and conference calls when needed. A kickoff meeting should be targeted hopefully for June before the summer holidays to get the work going.</P>
...
<P>In addition to the JSRs mentioned in Section 2.4, the following references may be applicable: 
<ul>
      <li>OpenGL - http://www.opengl.org 
      <li>VRML/X3D - http://www.web3d.org 
      <li>"Computer Graphics, Principles and Practice", Foley, Van Dam, Feiner and Hughes. </ul>
</P>

<H4>3.2 Explanation of how these items might be used as a starting point for the work.</H4>

<P>These references include a general description of available 3D standards, tools and techniques. </P>
