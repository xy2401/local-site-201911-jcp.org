...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 165</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=165">Community</a></div>
                        <div><a href="/en/eg/eghome?id=165">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=165">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=165">Proposal</a>
...
<div class="header1">JSR 165: SIMPLE Instant Messaging</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>Final Approval Ballot </td>
                                            ...
                                            <td><a href="results?id=3328">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Proposed Final Draft </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/pfd/jsr165/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Public Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/review/jsr165/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Draft Ballot </td>
                                            ...
                                            <td><a href="results?id=1744">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Community Review </td>
                                            ...
                                            <td><a href="http://www2.jcp.org/aboutJava/communityprocess/participant/jsr165/index.html">Login page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>JSR Review Ballot </td>
                                            ...
                                            <td><a href="results?id=948">View results</a></td>
...
3/16/05 - Changed JSR name from JAIN<font size="-2"><sup>TM</sup></font> SIMPLE Instant Messaging to SIMPLE Instant messaging. <BR><BR>
<B>Original Summary</b>: JAIN<font size="-2"><sup>TM</sup></font> SIMPLE Instant Messaging provides a standard portable and secure interface to exchange messages between SIMPLE clients. SIMPLE is an extension of SIP to support presence and instant messaging. .
<hr>
...
<P>This JSR aims to elaborate a JAIN<sup><font size="-2">TM</font></sup> API that leverages the Session Initiation Protocol (SIP) to provide instant messaging.<P>
The Session Initiation Protocol (SIP) is an IETF standard signaling protocol that can be used to establish, modify and terminate sessions in IP networks. SIMPLE is an IETF working group that advanced a set of extensions to SIP to support presence and instant messaging. This JSR aims to create a JAIN<sup><font size="-2">TM</font></sup> specification to the SIP extensions for instant messaging.
</P>

<H4>2.2 What is the target Java platform? (i.e., desktop, server,
personal, embedded, card, etc.)</H4>

<P>The target platform for JAIN<sup><font size="-2">TM</font></sup> SIMPLE Instant Messaging is the Java<sup><font size="-2">TM</font></sup> 2 micro and standard editions. The micro edition is meant to be the platform for client devices (primarily handsets). The standard edition is meant to be the platform for desktop-based clients.<P>
...
<P>There are no existing Java specifications of an API that support instant messaging on top of the SIP protocol.  It is well established that SIP offers tremendous advantages with the SIMPLE extensions to support presence and instant messaging: unification of major communication services, sharing of databases, sharing of proxies, sharing of servers, reduction of management costs, enabling of new combined services, etc. Moreover, JAIN<sup><font size="-2">TM</font></sup> SIMPLE Instant Messaging comes as a natural extension to the JAIN<sup><font size="-2">TM</font></sup> SIP and JAIN<sup><font size="-2">TM</font></sup> SIP Lite APIs.  As JAIN<sup><font size="-2">TM</font></sup> SIP is a standard API to the SIP protocol, and JAIN<sup><font size="-2">TM</font></sup> SIP Lite is a lightweight definition of SIP for user agents (including J2ME devices), in a similar vein, the JAIN<sup><font size="-2">TM</font></sup> SIMPLE Instant Messaging API is intended to be a standard API to the SIMPLE protocol (i.e. SIP augmented with instant messaging capabilities for server and client devices).
</P>
...
?	SIMPLE is a set of extensions made to the SIP protocol to support presence and instant messaging.<P>
...
?	JAIN<sup><font size="-2">TM</font></sup> SIP Lite is an abstract JAIN<sup><font size="-2">TM</font></sup> API to the SIP protocol that is dedicated to user agents running on both the J2SE and J2ME platforms.
...
<P>?	?	Panasonic JAIN<sup><font size="-2">TM</font></sup>-SIMPLE API is being elaborated as a joint research and development initiative between Columbia University (Dr. Henning Schulzrinne) and Panasonic Information and Networking Technologies Laboratory (Dr. Alexander Gelman and Dr. Mourad Debbabi).<P>
