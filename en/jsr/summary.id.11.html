...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 11</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=11">Community</a></div>
                        <div><a href="/en/eg/eghome?id=11">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=11">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=11">Proposal</a>
...
<div class="header1">JSR 11: JAIN<sup><font size="-2">TM</font></sup> TCAP Specification</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>Maintenance Draft Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/maintenance/jsr011/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Proposed Final Draft </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/first/jsr011/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Final Approval Ballot </td>
                                            ...
                                            <td><a href="results?id=217">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Public Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/review/jsr011/index.html">Download page</a></td>
...
<span style="padding: 10px; display: block;">
    ...
    <br><br>
        <b>Description</b>:<br>
        JAIN<sup><font size="-2">TM</font></sup> TCAP JSR is a proposed Java specification for the TCAP layer of the Signaling System 7 (SS7) stack.
    <br><br>
...
(JAIN) Transaction Capability Application Part (TCAP) Specification. It
will describe the Java standard API for transaction processing in the 
Telecommunications Industry.

<h4>
2.1 What is TCAP?</h4>

<p>TCAP adds transaction based functionality to the Public Switch Telephone
Network (PSTN).  TCAP is defined within the Signaling System 7 (SS7) specifications
as a communications protocol that maintains dialogue processing, activates remote
processes or features, and transfers switched based information from one telephony 
application to 
another.  TCAP applications handle numerous processing within the PSTN such
as 800 or free phone processing, 911 emergancy service, call forwarding,
call waiting, etc.
...
<p>The JAIN TCAP Specification is targeted towards Central Office switching
...
<p>The JAIN TCAP specification defines an API which allows for the 
...
deploy.  A JAIN TCAP component can be rapidly developed, tested, and
...
ITU'93, and ITU'97 TCAP specifications.  Instead of mapping the
standard specifications to a Java interface, the JAIN TCAP specification
abstracts a functional definition into the variant protocol stacks.  
<p>
The JAIN TCAP API is built upon the Java Beans Event model.  The protocol
stack vendor supplies the JAIN TCAP 'provider' interface into the protocol stack.
JAIN TCAP 'listeners' may readily be rolled onto the platform by an object
manager.
<p>
Proprietary stack features are hidden behind a JAIN TCAP 
Factory.  Through JAIN TCAP interfaces, a protocol stack provider is obtained from the 
factory, and 
JAIN TCAP listeners are then attached to the providers.

<h4>
2.5 Underlying technologies</h4>
<p>
The JAIN TCAP specification is based upon the underlying SS7 protocol stacks supplied
by the JAIN JSPA members and other 3rd party protocol stack implementations.  While
JAIN TCAP adapts well to other protocols such as TCP/IP, 1129+, or SIP, its initial purpose
is to provide a ubiquitous, standard Java interface into SS7 protocol stacks.
<p>
A JAIN TCAP application can be written as a program, applet, servlet, or bean.
...
<p>
While there is no dependancy on such tools to build a JAIN TCAP compont,
a Java Bean Manager
...
required to
send and receive TCAP messages.
<DT>jain.ss7.tcap.component
<DD>This package contains 
the Event classes representing  the component 
primitives and their parameters.
<DT>jain.ss7.tcap.dialogue
<DD>This package contains 
the Event classes representing  the TCAP
Dialogue handling primitives and their parameters.
</DL>
...
<p>None. JAIN TCAP expects to utilize standard JDK security.

<h4>
2.9 Internationalization implications</h4>

<p>Because JAIN TCAP is based on ITU specifications, the API can be readily 
adopted in the European market.  Adherance to Japanese standards will also make
JAIN TCAP ready for the Asian market.

<h4>
2.10 Localization implications</h4>
<p>Since JAIN TCAP is also based on ANSI/Bellcore standards, the TCAP API
can be readily adapted to most North American SS7 Protocol Stacks.

<h4>
2.11 Risk assessment</h4>
<p>JAIN TCAP moves Java into telco carrier grade service.  The Telcoms 
...
<P>
<a href="http://www.sun.com/products-n-solutions/telco/jain/index.html">
