...
<head>
    ...
    <script type="text/javascript" src="/includes/scripts/menu.js"></script>
        ...
        <title>The Java Community Process(SM) Program - JSRs: Java Specification Requests - detail JSR# 41</title>
...
<!-- ** END: header.jsp ** //-->
        ...
        <div id="p7TP1">
                <div class="p7TP_tabs">
                        ...
                        <div><a href="/en/egc/view?id=41">Community</a></div>
                        <div><a href="/en/eg/eghome?id=41">Expert Group</a></div>
                ...
                <div class="p7TPcontent">
                        <div id="p7tpc1_1">
                                ...
                                <a href="summary?id=41">Summary</a>
			
			
                                &nbsp;|&nbsp;
				<a href="proposalDetails?id=41">Proposal</a>
...
<div class="header1">JSR 41: A Simple Assertion Facility</div>
<div class="anybar"><img src="/images/global/bar_green.gif" alt="" width="12" height="4"></div>
<br>
			...
			<td>
				...
				<tr class="bgw" valign="top">
                                        <td>Final Approval Ballot </td>
                                            ...
                                            <td><a href="results?id=905">View results</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Proposed Final Draft </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/first/jsr041/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Public Review </td>
                                            ...
                                            <td><a href="http://jcp.org/aboutJava/communityprocess/review/jsr041/index.html">Download page</a></td>
				...
				<tr class="bgw" valign="top">
                                        <td>Participant Review </td>
                                            ...
                                            <td><a href="http://www2.jcp.org/aboutJava/communityprocess/participant/jsr041/index.html">Login page</a></td>
...
<span style="padding: 10px; display: block;">
    ...
    <br><br>
        <b>Description</b>:<br>
        A new keyword allowing programmers to include assertions describing intended program behavior, which can be checked as programs execute to detect bugs.<P>
    <br><br>
...
<TABLE CELLSPACING="3" CELLPADDING="3" WIDTH="100%">
        ...
        <TR>
                ...
                <TD BGCOLOR="#9999FF">Joshua Bloch</TD>
        </TR>
        <TR>
                <TD BGCOLOR="#CCCCFF" ALIGN=RIGHT>E-Mail Address:</TD>
                <TD BGCOLOR="#CCCCFF"><A HREF="mailto:jbloch&#64;eng.sun.com">jbloch&#64;eng.sun.com</A></FONT></TD>
        </TR>
        <TR>
                <TD BGCOLOR="#9999FF" ALIGN=RIGHT>Telephone Number:</TD>
                <TD BGCOLOR="#9999FF">+1 408 343 1833</TD>
        </TR>
        <TR>
...
<i>Assertions</i> are boolean expressions that the programmer believes to be
...
<p>Many popular programming languages, including C and C++, have widely used
...
<ul>
<li>The facility should be simple and intuitive; it should not change the
character of the language.  The facility should be sufficiently pleasant to
use that its use becomes widespread.

<li>It should be possible to disable the facility at a reasonably fine
granularity, and to enable assertion checking in the field.

<li>The facility should impose negligible runtime cost when it is disabled.

<li>The facility should require no change to the class file format,
and little or (preferably) no change to the JVM.
        ...
        <TR>
                <TD>The Java programming language.  (All editions of the Java platform.)</TD>
        </TR>
...
the bug parade).
        ...
        <TR>
                <TD>There are currently no specifications in this area.</TD>
        </TR>

        <TR>
                <TD><STRONG>2.5 Please give a short description of the underlying technology or technologies:</STRONG></TD>
        </TR>
...
requiring only a very modest change to the compiler.
        ...
        <TR>
                <TD><STRONG>2.6 Is there a proposed package name for the API Specification?</STRONG></TD>
        </TR>

        <TR>
                <TD>(We anticipate no new packages would be added as a result of this specification.)</TD>
        </TR>

        <TR>
                <TD><STRONG>2.7 Does the proposed specification have any dependencies on specific operating systems, CPUs, or I/O devices that you know of?</STRONG></TD>
        </TR>
...
security model?</STRONG></TD>
        ...
        <TR>
                <TD>We may want to make some provision for localized assertion failure messages.</TD>
        </TR>
...
<TABLE CELLSPACING="3" CELLPADDING="3" WIDTH="100%">
        <TR>
                <TD><STRONG>3.1> Please list any existing documents, specifications, or implementations 
that describe the technology. Please include links to the documents if they are publicly available.</STRONG</TD>
        </TR>

        <TR>
                <TD>
Sun has developed <a href="/content/main/jsr/detail/materials/asrt_prop.html">a proposal for simple assertion
facility</a>. It is hoped that this API will form the basis for the
specification.
                </TD>
        </TR>

        <TR>
                <TD><STRONG>3.2 Explanation of how these items might be used as a starting point for the 
work.</STRONG></TD>
        </TR>

        <TR>
                <TD>In the usual way: the expert
committee will study the proposal for shortcomings and do its best to rectify them.</TD>
        </TR>
</TABLE>
</p>
